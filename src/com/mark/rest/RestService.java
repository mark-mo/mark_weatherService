...
import com.mark.model.WeatherModel;
...
//    Logger logger = LoggerFactory.getLogger(RestService.class);
     ...
     * TODO: Going to return a Move object with this method after ensuring the connection between this and the PI
     * TODO: Change to GET after ensuring it works
     * 
    ...
    public WeatherModel saveAccelSensorData(WeatherModel model)
    {
